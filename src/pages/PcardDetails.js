...
import { Card, CardContent, Typography, List, ListItem, ListItemText, Button, Divider, CardMedia, Grid2, CircularProgress } from '@mui/material';

function PcardDetails({ details, isLoading, error }) {
    if (isLoading) {
